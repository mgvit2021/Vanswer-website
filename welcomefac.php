<?php
    ...
    $arr = array();
    $arr2 = array();
    $qsql = "SELECT question,name,q.askid,id,regno from questions q, info_acc i where q.askid=i.regno and field='$fac'";
    $q3 = "select question,name,q.askid,id,regno from questions q,followques f,info_acc i where q.id=f.qid and q.askid=i.regno and field='$fac' group by question order by count(id) desc";
    $count = 0;
...
.button-success,
    ...
    <body>
        ...
        <ul class="topnav">
                ...
                <li><button id="teacher"><i class="fas fa-user"></i>&nbsp; <?php echo $name; ?></button></li>  
